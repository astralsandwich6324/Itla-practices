...
namespace DentalClinic.Web.Controllers
{
    public class TreatmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Costo")] Treatment treatment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,Costo")] Treatment treatment)
        {
            if (id != treatment.Id)
            {
                return NotFound();
